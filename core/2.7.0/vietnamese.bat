...
echo Replacing "english" with "vietnamese" in all folder and file names...
...
for /f "delims=" %%a in ('dir /b /s /ad ^| sort /r') do (
    ...
    if "!foldername!"=="!foldername:english=!" (
        ...
        set "newfoldername=!foldername:english=vietnamese!"
        set "parentpath=%%~dpa"
...
for /f "delims=" %%a in ('dir /b /s /a-d') do (
    ...
    if "!filename!"=="!filename:english=!" (
        ...
        set "newfilename=!filename:english=vietnamese!"
        set "parentpath=%%~dpa"
